...
class strChange:
    def __init__(self,file_path,newurl,newdb):
    ...
    def checkdir(self):
        if not os.path.exists("C:/Users/admin/Desktop/test"):
            os.mkdir('C:/Users/admin/Desktop/test')
        else:
            shutil.rmtree('C:/Users/admin/Desktop/test')
            os.mkdir('C:/Users/admin/Desktop/test')
